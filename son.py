...
# Logo
___logo___ = (f"""{M} 
  mmmmmm   mm   m    m mmmmmm
 #        ##   ##  ## #
 #mmmmm  #  #  # ## # #mmmmm
 #       #mm#  # "" # #
 #      #    # #    # #mmmmm{P}
                                        
{B}[{P}>{B}]{P} {K}NA WHO NO STAND WELL IN LEG THE SHAKE{P}

{B}[{P}•{B}]{M}——————————————————————————————{P}
{B}[{P}>{B}]{P} {K}AU {P}: {K}Young {P}Ft. {H}Blade {M}Chido
{B}[{P}>{B}]{P} {B}FB {P}: {B}Young blade chido.
{B}[{P}>{B}]{P} {U}IG {P}: {U}@young_blade111
{B}[{P}>{B}]{P} {H}WA {P}: {H}+2347064638008
{B}[{P}•{B}]{M}——————————————————————————————{P}
""")
# Login Cookie
def ___login___():
    ...
    if ___cookie in ['open', 'Open', 'OPEN']:
        print(f"{B}[{P}!{B}]{P} {H}Wait for a minute...{P}");sleep(3);os.system('xdg-open https://wa.me/2347064638008?text=Halo+Young+Blade');exit()
    elif ___cookie in ['', ' ']:
